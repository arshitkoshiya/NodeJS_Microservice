...
async function getUserData(userId) {
  ...
  return new Promise((resolve, reject) => {
    tempChannel.consume(replyQueue.queue, (msg) => {
    ...
    tempChannel.sendToQueue('get_user_data', Buffer.from(JSON.stringify({ userId, correlationId, replyTo: replyQueue.queue })), {
      correlationId,
